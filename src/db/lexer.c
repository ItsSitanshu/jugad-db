...
char* keywords[NO_OF_KEYWORDS] = {
  "SELECT", "INSERT", "UPDATE", "DELETE", "CRT", "DROP", "ALTER", "TABLE", "FROM", "WHERE",
  "AND", "OR", "NOT", "ORDER", "BY", "GROUP", "HAVING", "LIM", "OFFSET", "VALUES",
  "SET", "INTO", "AS", "JOIN", "ON", "IN", "IS", "NULL", "DISCT", "PK",
  "FK", "REF", "INDEX", "CAST", "CASE", "WHEN", "THEN", "ELSE", "END", "DEFAULT",
  "CHECK", "UNIQUE", "CONSTR", "fSUM"
};
...
Token* lexer_handle_alpha(Lexer* lexer) {
  ...
  */
  ...
  uint8_t KWCHAR_TYPE_MAP[NO_OF_KEYWORDS] = {
    ...
    TOK_SET, TOK_INT, TOK_AS, TOK_JN, TOK_ON, TOK_IN, TOK_IS, TOK_NL, TOK_DST, TOK_PK,
    TOK_FK, TOK_REF, TOK_IDX, TOK_CST, TOK_CSE, TOK_WHEN, TOK_THEN, TOK_ELS, TOK_END, TOK_DEF,
    TOK_CHK, TOK_UNQ, TOK_CNST, TOK_FNSUM
  };
